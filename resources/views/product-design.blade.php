...
<body>
<header class="top-header-cont">
    <div class="inner-top-header">
        <ul class="top-header-menus-cont">
            <li class="top-header-menu menu-active"><a href="" class="top-header-link"><span class="menu-num-icon">1</span>design</a></li>
            <li class="top-header-menu"><a href="" class="top-header-link"><span class="menu-num-icon">2</span>ordering options</a></li>
            <li class="top-header-menu"><a href="" class="top-header-link"><span class="menu-num-icon">3</span>quantity & size</a></li>
            <li class="top-header-menu"><a href="" class="top-header-link"><span class="menu-num-icon">4</span>review</a></li>

        </ul>

        <ul class="top-header-menus-cont right-menu-cont">
            <li class="top-header-chat"><a href="" class="top-header-chat-link">
                <i class="bi bi-chat-right-dots-fill"></i>
                <p class="top-header-chat-text">
        ...
        {{-- <li class="top-header-chat"><a href="" class="top-header-chat-link">
            <i class="bi bi-chat-right-dots-fill"></i>
            <p class="top-header-call-text">
                <span>(1800) 620-1234</span>
                <span>Talk to an Expert</span>
            </p>
        </a>
    </li> --}}
    <li class="top-header-menu"><a href="" class="top-header-link"><i class="bi bi-cart-fill"></i>card</a></li>
    {{-- <li class="top-header-menu"><a href="" class="top-header-link"><i class="bi bi-person-circle"></i>login</a></li> --}}
        </ul>
    </div>
</header>
{{-- side menus --}}
<div class="" id="tab_1">
    <aside class="side-menu-cont">
        <div class="aside-logo-cont">
            <img src="{{ asset('images/rushordertees.com-logo-mobile.png') }}" alt="">
        </div>
        <div class="aside-menu-list">
            <ul>
                <li class="aside-menu-active"><a href=""><svg version="1.0" id="ICONS" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20.1 18.3" style="enable-background:new 0 0 20.1 18.3;" xml:space="preserve">
                ...
                <li class=""><a href=""><svg version="1.0" id="ICONS" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" style="enable-background:new 0 0 20 20;" xml:space="preserve">
                    <style type="text/css">
                    </style>
                    <g>
                ...
                <li class=""><a href=""><svg version="1.0" id="ICONS" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 19.948 18.2" style="enable-background:new 0 0 19.948 18.2;" xml:space="preserve">
                    <style type="text/css">
                    </style>
                    <g>
                ...
                <li class=""><a href=""><svg version="1.0" id="Layer_4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 19.9 20" style="enable-background:new 0 0 19.9 20;" xml:space="preserve">
                    <style type="text/css">
                    </style>
                    <g>
                ...
                <li class=""><a href=""><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 562.1 562.1" style="enable-background:new 0 0 562.1 562.1;" xml:space="preserve">
                ...
                <li class=""><a href=""><svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve">
    ...
    <div class="product-body">
        <div class="product-design-options">
           <h1>style</h1>
        </div>
    ...
    <footer class="bottom-menu-cont">
        <div class="inner-footer">
            <button class="save-btn"><i class="bi bi-floppy-fill" style="padding-right: 6px"></i>Save </button>

            <button class="next-btn">next step <i class="bi bi-arrow-right" style="padding-left: 6px"></i></button>
        </div>
    </footer>
</div>
